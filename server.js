...
=== 자격증/수상 활용 규칙 ===
지원자 프로필에 자격증이나 수상 내역이 있을 경우:
- 해당 직무와 관련성이 높은 자격증은 반드시 "관련 경험/역량" 섹션에서 구체적으로 언급하세요
- 예: "인공지능전문가 1급 자격을 보유하고 있어 AI 기반 마케팅에 전문성을 갖추고 있습니다"
- 직무와 직접적 관련이 없는 자격증(예: 운전면허)은 생략 가능
- 자격증이 있다면 최소 1개 이상은 반드시 자소서에 포함해야 합니다
